...
export const WEAPON_DATA = {
    ...
    "minecraft:air": { p: 0, m: 0, cooldown:1},
    "minecraft:stone": { p: 15, m: 0, desc: "근본 있는, 인류의 무기", cooldown:3},
    "bridge:ironsword": { p: 7, m: 0, desc: "많은 이들의 손을 거치며 칼날은 무뎌졌지만, 강도만큼은 여전하다.", cooldown:6 },
    "bridge:myweapon": { p: 1000, m: 0, desc: "아주 오래된 무기다.", cooldown:100},
